...
string oldFilePath = "/Users/kushtar/Desktop/SpiderSources/Film/Film.json";
// string indexFilePath = "/Users/kushtar/Desktop/SpiderSources/Film/index.txt";
// string siteUrl = "https://3bt0.com";
string filePath = "/Users/kushtar/Desktop/SpiderSources/Film/NewFilm2.json";
// int maxPageNum = 3855;

string oldContent = File.ReadAllText(oldFilePath);
List<Film> oldFilmList = JsonHelper.DeSerializeObject<List<Film>>(oldContent);

List<Film> films = [.. oldFilmList.OrderBy(f => f.PageIdx)];
string content = JsonHelper.SerializeObject(films);
